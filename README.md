...
# 工夫した点
今回はRails7でアプリ開発を始め、turboを意識して作ったところです。<br>
1つがいいね機能ですが、turbo_streamを使ってajaxに実装しています。web上ではjavascript を使った実装が多く見つかったんですが、せっかくrails7のTurboを使えば javascriptを書かないで実装できるということでコードを書いています。<br>
2つ目は、 gem のkaminariを使ったページネーションとransackの検索機能もturbo_frameタグ を記述して、画面遷移が高速になるようにした点です。

# 今後の課題
1つは登録されている場所へのコメント機能です。コメント欄があれば、書かれている情報の真偽もわかりますし、実際に行ってみたユーザがどういう体験をしたのかを共有できると、他のユーザにとってもよりわかりやすいものになると思います。<br>
もう1つは、今週よくアクセスされているランキング機能があれば、どこにすれば選ぶ決め手がないユーザの方にも、お出かけ場所を探しやすくなってもらえると考えています。
